...
import firstImg from "../images/more/3.png";

const Banner = () => {
  const [currentSlider, setCurrentSlider] = useState(0);
  const carouselImages = [
    "https://i.ibb.co.com/pJ5SQbL/coffe1.jpg",

    "https://i.ibb.co.com/1vBfBDc/coffee2.jpg",

    "https://i.ibb.co.com/1Z7DMxr/coffe3.jpg",

    "https://i.ibb.co.com/YhXB1XZ/28.jpg",

    "https://i.ibb.co.com/C2j1bd8/6.jpg",
  ];
  const prevSlider = () =>
